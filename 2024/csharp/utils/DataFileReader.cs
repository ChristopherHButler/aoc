...
// if no parameter is suppied, it will create the file name it wants to use from the date you pass in.
...
public class DataFileReader
{
    ...
    public DataFileReader(string? filename = null, string? date = null, bool? useTestData = false, int? part = 0, bool verbose = false)
    {
        ...
        else
        {
            ...
            var filePath = Path.GetFullPath(Path.Combine(Environment.CurrentDirectory, @"../common/data"));
    ...
    public void ReadFile(bool verbose = false)
    {
        try
        {
